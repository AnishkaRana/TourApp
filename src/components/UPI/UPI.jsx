...
<div className="AndroidLarge3" style={{width: 412, height: 870, position: 'relative', background: '#BCC3E7', borderRadius: 30, overflow: 'hidden'}}>
  ...
  <div className="Phonepe" style={{width: 140, height: 75, left: 168, top: 49, position: 'absolute', color: 'black', fontSize: 40, fontFamily: 'Lora', fontWeight: '400', wordWrap: 'break-word'}}>UPI</div>
  <div className="Ellipse11" style={{width: 63, height: 40, left: 168, top: 11, position: 'absolute', background: '#E3E5F5', borderRadius: 9999}} />
  <img className="IconsUPI" style={{width: 73, height: 58, left: 164, top: 105, position: 'absolute', marginBottom:5,}} src={UPIimg}/>
  ...
  <div className="EnterPaytmNumber" style={{width: 227, height: 30, left: 33, top: 209, position: 'absolute', color: 'black', fontSize: 15, fontFamily: 'Lora', fontWeight: '400', wordWrap: 'break-word'}}>Enter UPI ID</div>
  <input className="Rectangle13" style={{width: 201, height: 34, left: 25, top: 250, position: 'absolute', background: '#BCC3E7', borderRadius: 30}} placeholder=''/>
